...
from tasks.serializers.task_serializer import TaskSerializer, TaskListSerializer
...
def  task_api_view(request):
    ...
    if request.method == 'GET':
        tasks = Task.objects.all().values('id','name','description','state', 'priority', 'delivery_date')
